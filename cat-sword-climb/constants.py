...
MOBILE_NAME_ENTRY_ACTION_SUPPRESS_MS = 220
...
REENTRY_MIN_HEIGHT = 900.0
REENTRY_LIGHT_FALL_DISTANCE = 220.0
REENTRY_MIN_FALL_SPEED = 700.0
DEBUG_ALTITUDE_JUMP_HEIGHT = 2000.0
INK = (28, 25, 31)
WHITE = (245, 245, 239)
CAT = (236, 190, 124)
CAT_DARK = (132, 88, 58)
...
BALLOON_SPRITE_NAMES = ("red", "yellow", "green", "blue")
